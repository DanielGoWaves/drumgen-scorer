  ...
  return (
    <div className="grid" style={{ maxWidth: '1400px', margin: '0 auto' }}>
      ...
      {!loading && hasData && selectedVersion === 'all' && analytics.by_version && analytics.by_version.length > 0 && (
        ...
        <div style={{ fontSize: '36px', fontWeight: '700', marginBottom: '8px', display: 'flex', alignItems: 'baseline', justifyContent: 'center', gap: '2px' }}>
          <span style={{ color: getScore100Color(version.generation_score) }}>
            {version.generation_score}
          </span>
          <span style={{ color: score10Green, fontSize: '14px', fontWeight: '500' }}>/100</span>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{ fontWeight: '600', fontSize: '16px', marginTop: '4px', display: 'flex', alignItems: 'baseline', justifyContent: 'center', gap: '2px' }}>
            <span style={{ color: getScore100Color(version.avg_llm * 10) }}>
              {version.avg_llm}
            </span>
            <span style={{ color: score10Green, fontSize: '10px', fontWeight: '500' }}>/10</span>
          </div>
        </div>
